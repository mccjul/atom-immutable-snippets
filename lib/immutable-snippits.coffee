...
module.exports =
  ...
  activate: (state) ->
    atom.commands.add 'atom-text-editor',
      'immutable-snippits:end-line': => @endLine(';', false)
    atom.commands.add 'atom-text-editor',
      'immutable-snippits:end-line-comma': => @endLine(',', false)
    atom.commands.add 'atom-text-editor',
      'immutable-snippits:end-new-line': => @endLine('', true)
    atom.commands.add 'atom-text-editor',
      'immutable-snippits:wrap-block': => @wrapBlock()
